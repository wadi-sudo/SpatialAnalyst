...
class Cafe(models.Model):
    ...
    name_2 = models.CharField(max_length=-1, blank=True, null=True)
...
class Food(models.Model):
    ...
    path = models.CharField(max_length=-1, blank=True, null=True)
...
class Road(models.Model):
    ...
    osm_id = models.CharField(max_length=-1, blank=True, null=True)
    highway = models.CharField(max_length=-1, blank=True, null=True)
